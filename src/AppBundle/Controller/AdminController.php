...
class AdminController extends BaseAdminController {
    ...
    public function prePersistConferenceEntity($conference) {
        $conference->setCreatedUser($this->get('security.token_storage')->getToken()->getUser());
    }

    public function preUpdateConferenceEntity($conference) {
        $conference->setUpdatedUser($this->get('security.token_storage')->getToken()->getUser());
